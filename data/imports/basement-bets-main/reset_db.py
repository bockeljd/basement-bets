...
from src.database import get_db_connection, init_db, init_transactions_tab, init_model_history
...
def reset():
    ...
    # It calls init_transactions_tab() and others? 
    ...
    # checking imports...
    # I can import init_transactions_tab. 
